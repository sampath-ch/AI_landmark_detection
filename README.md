...
1. Upload a real reference image (anchor)
2. Upload the target image
3. Select a region using two clicks (bounding box)
4. Click "Analyze Rigid Geometry"
5. Inspect feature matches and pose drift results
